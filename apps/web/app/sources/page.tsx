...
export default async function SourcesPage() {
  ...
  return <main className="page-shell subpage">
    ...
    <div className="model-grid"><article><span>NOAA Storm Events 2025</span><h2>Weather impact outcomes</h2><p>Injuries, deaths, duration, and normalized damage proxies. Source archive SHA-256 is recorded by the reproducible dataset manifest.</p></article><article><span>USGS Earthquake Catalog 2025</span><h2>Earthquake impact outcomes</h2><p>Magnitude, depth, significance, felt reports, intensity, tsunami, and alert proxies from the FDSN catalog.</p></article></div>
  </main>;
}
