...
export const fallbackData: DashboardData = {
  ...
  resources: [
    { id: "res-usar-01", name: "Urban Search & Rescue 01", kind: "rescue", status: "ready", quantity: 42, available: 32, latitude: 33.75, longitude: -84.39, capabilities: ["medical", "swift-water", "structural"] },
